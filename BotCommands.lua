...
local function OnBotCommandHandlerTwo(event, player, command)
    ...
    elseif role == "bullets" then
        ...
        player:SendBroadcastMessage("Invalid role specified. Usage: .bot items [role]. Valid roles are 'caster', 'leatherdps', 'tank', 'maildps', 'platedps', 'plateheals', 'mailcaster', 'leathercaster', 'twohanders', 'onehanders', 'idols', 'librams', 'totems', 'ranged', 'arrows', 'bullets'.")
        return false
    end
