...
local CasterItems = {
    ...
    [70] = {34340, 34359, 34210, 34364, 30038, 34181, 32239, 30870, 34344, 27996, 34362, 32483, 44073, 34242, 34182, 34347},
...
local PhysicalItems = {
	...
	[60] = {13404, 15411, 13257, 15825, 16713, 29964, 12470, 19589, 16712, 17713, 22255, 34423, 11815, 19982},
...
local function OnBotCommandHandlerTwo(event, player, command)
    ...
    elseif role == "bullets" then
        ...
        player:SendBroadcastMessage("Invalid role specified. Usage: .bot items [role]. Valid roles are 'caster', 'leatherdps', 'tank', 'maildps', 'platedps', 'plateheals', 'mailcaster', 'leathercaster', 'twohanders', 'onehanders', 'ranged', 'arrows', 'bullets'.")
        return false
    end
